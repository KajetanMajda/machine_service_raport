...
//         fetchReportsByYear(activeCategory, selectedYear);
//     });

//     // Inicjalizuj inne funkcje, jak fetchReports itp.
// });

// function fetchReportsByYear(category, year) {
//     fetch(`/api/report/category/${encodeURIComponent(category)}/year/${encodeURIComponent(year)}`)
